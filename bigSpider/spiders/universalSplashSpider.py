...
import json
import pymongo
from ..util.common import getDomain, getConfigFromDB, cleanHtmlTag, logger
...
class UniversalSplashSpider(scrapy.Spider, BaseFunctions):
    name = 'universalSplashSpider'
    allowed_domains = []
    start_urls = []

    settings.COOKIES_ENABLES = False
    settings.DOWNLOAD_DELAY = 4
    ...
    def __init__(self, conf=None, crawl_no=None, name=None, **kwargs):
        super(UniversalSplashSpider, self).__init__(name, **kwargs)
